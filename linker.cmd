...
SECTIONS
{
	...
	/* This is where the libc functions go */
	GROUP {
		.text.sqrtf: palign(8)

    	.text.sinf: palign(8)
    	.text.__kernel_sindf: palign(8)
    	.text.cosf: palign(8)
		.text.__kernel_cosdf: palign(8)
...
MEMORY
{
    ...
    R5F_TCMA0  : ORIGIN = 0x00000040 , LENGTH = 0x00003FC0
    R5F_TCMA1  : ORIGIN = 0x00004000 , LENGTH = 0x00002000
    R5F_TCMA2  : ORIGIN = 0x00006000 , LENGTH = 0x00002000
    R5F_TCMB1  : ORIGIN = 0x00080000 , LENGTH = 0x00004000
    R5F_TCMB2  : ORIGIN = 0x00084000 , LENGTH = 0x00004000
